...
SDL_wcslen(wstr *ushort) ulong #Foreign("SDL_wcslen")
SDL_wcslcpy(dst *ushort, src *ushort, maxlen ulong) ulong #Foreign("SDL_wcslcpy")
SDL_wcslcat(dst *ushort, src *ushort, maxlen ulong) ulong #Foreign("SDL_wcslcat")
SDL_wcsdup(wstr *ushort) *ushort #Foreign("SDL_wcsdup")
SDL_wcsstr(haystack *ushort, needle *ushort) *ushort #Foreign("SDL_wcsstr")
SDL_wcscmp(str1 *ushort, str2 *ushort) int #Foreign("SDL_wcscmp")
SDL_wcsncmp(str1 *ushort, str2 *ushort, maxlen ulong) int #Foreign("SDL_wcsncmp")
...
SDL_ltoa(value int, str *sbyte, radix int) *sbyte #Foreign("SDL_ltoa")
SDL_ultoa(value uint, str *sbyte, radix int) *sbyte #Foreign("SDL_ultoa")
...
SDL_strtol(str *sbyte, endp **sbyte, base int) int #Foreign("SDL_strtol")
SDL_strtoul(str *sbyte, endp **sbyte, base int) uint #Foreign("SDL_strtoul")
...
SDL_vsscanf(text *sbyte, fmt *sbyte, ap *sbyte) int #Foreign("SDL_vsscanf")
SDL_snprintf(text *sbyte, maxlen ulong, fmt *sbyte) int #VarArgs #Foreign("SDL_snprintf")
SDL_vsnprintf(text *sbyte, maxlen ulong, fmt *sbyte, ap *sbyte) int #Foreign("SDL_vsnprintf")
...
SDL_RegisterApp(name *sbyte, style uint, hInst pointer) int #Foreign("SDL_RegisterApp")
SDL_UnregisterApp() void #Foreign("SDL_UnregisterApp")
...
SDL_CreateThread(fn pointer #As("SDL_ThreadFunction"), name *sbyte, data pointer, pfnBeginThread pointer #As("pfnSDL_CurrentBeginThread"), pfnEndThread pointer #As("pfnSDL_CurrentEndThread")) pointer #As("SDL_Thread *") #Foreign("SDL_CreateThread")
SDL_CreateThreadWithStackSize(fn pointer #As("int (*)(void *) __attribute__((cdecl))"), name *sbyte, stacksize ulong, data pointer, pfnBeginThread pointer #As("pfnSDL_CurrentBeginThread"), pfnEndThread pointer #As("pfnSDL_CurrentEndThread")) pointer #As("SDL_Thread *") #Foreign("SDL_CreateThreadWithStackSize")
SDL_GetThreadName(thread pointer #As("SDL_Thread *")) *sbyte #Foreign("SDL_GetThreadName")
SDL_ThreadID() uint #Foreign("SDL_ThreadID")
SDL_GetThreadID(thread pointer #As("SDL_Thread *")) uint #Foreign("SDL_GetThreadID")
...
SDL_TLSSet(id uint, value pointer, destructor pointer #As("void (*)(void *) __attribute__((cdecl))")) int #Foreign("SDL_TLSSet")
...
SDL_RWFromFP(fp pointer, autoclose SDL_bool #As("SDL_bool")) *SDL_RWops #As("SDL_RWops *") #Foreign("SDL_RWFromFP")
...
SDL_LogMessageV(category int, priority SDL_LogPriority #As("SDL_LogPriority"), fmt *sbyte, ap *sbyte) void #Foreign("SDL_LogMessageV")
...
SDL_SetWindowsMessageHook(callback pointer #As("SDL_WindowsMessageHook"), userdata pointer) void #Foreign("SDL_SetWindowsMessageHook")
SDL_Direct3D9GetAdapterIndex(displayIndex int) int #Foreign("SDL_Direct3D9GetAdapterIndex")
SDL_RenderGetD3D9Device(renderer pointer #As("SDL_Renderer *")) pointer #As("IDirect3DDevice9 *") #Foreign("SDL_RenderGetD3D9Device")
SDL_DXGIGetOutputInfo(displayIndex int, adapterIndex *int, outputIndex *int) SDL_bool #As("SDL_bool") #Foreign("SDL_DXGIGetOutputInfo")
